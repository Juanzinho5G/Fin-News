...
NoticiasModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([noticias_repository_1.noticiasRepository]),
            redator_module_1.RedatorModule
        ],
        controllers: [noticias_controller_1.NoticiasController],
        providers: [noticias_service_1.NoticiasService],
        exports: [noticias_service_1.NoticiasService]
    })
], NoticiasModule);
